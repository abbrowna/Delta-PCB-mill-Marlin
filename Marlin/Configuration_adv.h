...
//#define MICROSTEP16 HIGH,HIGH,HIGH //For A4988 drivers
 ...
 *    M907 - applies to all.
 *    M908 - BQ_ZUM_MEGA_/3D, RAMBO, PRINTRBOARD_REVF, RIGIDBOARD_V2 & SCOOVO_X9H
...
#define ARC_SUPPORT                 // Disable this feature to save ~3226 bytes
  ...
  #define MM_PER_ARC_SEGMENT      0.01 // (mm) Length (or minimum length) of each arc segment
...
//#define LASER_FEATURE
  ...
  //#define CUTTER_POWER_RELATIVE              // Set speed proportional to [SPEED_POWER_MIN...SPEED_POWER_MAX]
    ...
    #define SPINDLE_LASER_POWERUP_DELAY   8000 // (ms) Delay to allow the spindle/laser to come up to speed/power
    #define SPINDLE_LASER_POWERDOWN_DELAY 8000 // (ms) Delay to allow the spindle to stop
