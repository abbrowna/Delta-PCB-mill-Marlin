...
#define DELTA
  ...
  #define DELTA_DIAGONAL_ROD 275.884        // (mm)

  // Distance between bed and nozzle Z home position
  #define DELTA_HEIGHT 112.70            // (mm) Get this value from G33 auto calibrate

  #define DELTA_ENDSTOP_ADJ { -1.21, 0.0, -1.40 } // Get these values from G33 auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 153.81              // (mm) Get this value from G33 auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.09, -0.14, 0.24 } // Get these values from G33 auto calibrate
